...
urlpatterns = [
    ...
    path("<str:municipality_slug>/prikaz-sredstev-skozi-cas/", RedirectView.as_view(url="/%(municipality_slug)s/primerjava-skozi-cas/", query_string=True)),
    ...
    path("<str:municipality_slug>/primerjava-skozi-cas/", views.comparison_over_time, name="comparison_over_time"),
