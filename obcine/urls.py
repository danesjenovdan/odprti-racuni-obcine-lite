...
urlpatterns = [
    ...
    path('razrez-sredstev/<int:municipality_id>/', views.cut_off_funds, name='cut_of_funds'),
    path('razrez-sredstev/<int:municipality_id>/<int:year_id>/', views.cut_off_funds, name='cut_of_funds'),
